...
const schema = radioGroupSchema("exercisePublicPower", "bool");

const ExercisePublicPowerStep = () => {
  const { pagination, data } = useContext(FormContext);

  const enterPressed = useKeyPress("Enter");

  const handleGroupSelect = (evt, value) => {
    formik.setFieldValue("exercisePublicPower", value === "true");
  };
  ...
  return (
    <Box sx={defaultStepContainerSx}>
      <Box>
        ...
        <RadioGroup
          value={formik.values.exercisePublicPower}
          error={Boolean(formik.errors.exercisePublicPower)}
          helperText={formik.errors.exercisePublicPower}
...
export default ExercisePublicPowerStep;
