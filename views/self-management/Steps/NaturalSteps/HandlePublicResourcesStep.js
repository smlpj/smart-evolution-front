...
const schema = radioGroupSchema("handlePublicResources", "bool");

const HandlePublicResourcesStep = () => {
  const { pagination, data } = useContext(FormContext);

  const enterPressed = useKeyPress("Enter");

  const handleGroupSelect = (evt, value) => {
    formik.setFieldValue("handlePublicResources", value === "true");
  };
  ...
  return (
    <Box sx={defaultStepContainerSx}>
      <Box>
        ...
        <RadioGroup
          value={formik.values.handlePublicResources}
          error={Boolean(formik.errors.handlePublicResources)}
          helperText={formik.errors.handlePublicResources}
...
export default HandlePublicResourcesStep;
